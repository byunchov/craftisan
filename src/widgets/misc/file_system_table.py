...
from qtpy.QtCore import Qt, Slot, Property, Signal, QFile, QFileInfo, QDir, QIODevice, QItemSelectionModel
...
class QFileSystemTable(QTableView, TableType):
    ...
    def loadFile(self, path):
        ...
        #         # Found the matching text, select the entire row
        #         self.selection_model.select(index, QTableView.Select | QTableView.Rows)
        #         self.scrollTo(index, QTableView.PositionAtTop)
        #         break
