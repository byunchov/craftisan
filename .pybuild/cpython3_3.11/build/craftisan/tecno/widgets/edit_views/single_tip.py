...
class SingleTipDataWidget(BaseEditWidget):

    def __init__(self, parent = None) -> None:
        super(SingleTipDataWidget, self).__init__(parent)
    ...
    def initUi(self):
        ...
        self.tipLWLbl = QLabel('[L1] Work Lenght')
        ...
        self.spindleDirLbl = QLabel('Spindle Dir.')
    ...
    def validate(self):
        ...
        self.tool.setTipWorkDepth(self.tipLWInput.value())
